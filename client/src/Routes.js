...
import adminLanguage from './page/admin/adminLanguage';
// My pages end
  ...
  render() {
    return (
      <Switch>
        ...
        <Route exact path = "/adminPortfolio" component = {adminPortfolio}/>
        <Route exact path = "/adminLanguage" component = {adminLanguage}/>
